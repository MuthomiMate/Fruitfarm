               ...
               <div class="card hoverable animated slideInUp wow">
                 <div class="card-image">
                     <a href="product.php?id=<?= $id_product; ?>">
                       <img  style="background-image: url('products/<?= $thumbnail_product; ?>'); background-repeat: no-repeat; background-size: contain;" alt="" height="210px"></a>
                   ...
                   <div class="card-action">
                     ...
                     <span class="grey-text"><?= $name_product; ?></span>
                       <h5 class="white-text">Ksh <?= $price_product; ?> </h5>
                     </div>
                   </div>
               </div>
             </div>
